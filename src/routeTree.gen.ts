...
export interface FileRouteTypes { fileRoutesByFullPath: FileRoutesByFullPath; fullPaths: '/' | '/auth' | '/onboarding' | '/daily-summary' | '/menu' | '/new-order' | '/orders/$id' | '/orders/$id/receipt' | '/orders/' | '/shifts' | '/user-management'; to: '/' | '/auth' | '/onboarding' | '/daily-summary' | '/menu' | '/new-order' | '/orders/$id' | '/orders/$id/receipt' | '/orders' | '/shifts' | '/user-management'; id: '__root__' | '/' | '/auth' | '/onboarding' | '/daily-summary' | '/menu' | '/new-order' | '/orders/$id' | '/orders/' | '/orders/$id/receipt' | '/shifts' | '/user-management'; fileRoutesByTo: FileRoutesByTo; fileRoutesById: FileRoutesById }
